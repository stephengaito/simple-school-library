# This is an altered copy of sqlite3v3_12_3-dump.py used under the CPython
# License. See: sqlite3v3_12_3-dump.py-LICENSE

# Our changes are noted below see: `Simple-School-Library` below
...
def ssl_iterdump(connection, tableList=None):
    """
    ...
    for table_name, type, sql in schema_res.fetchall():
        if tableList and table_name not in tableList : continue
        if table_name == 'sqlite_sequence':
            ...
            # Simple-School-Library : we ignore Full Text Search tables as
            # we actively rebuild these tables
            continue
